...
from user.forms import LoginForm, RegForm, ChangeNickForm, BindEmailForm, ChangePasswordForm, ForgotPasswordForm
...
def forgot_password(request):
    ...
    return render(request, 'user/forgot_password.html', context=context)